...
parser.add_argument('--n_img_row', type=int, default=96)
parser.add_argument('--n_img_col', type=int, default=96)
parser.add_argument('--n_img_channels', type=int, default=1)
parser.add_argument('--n_classes', type=int, default=5)
parser.add_argument('--lr', type=float, default=1e-3)
parser.add_argument('--model', default='MCAP')
...
parser.add_argument('--mode', dest='MODE', default='train', help='among train & test')
